%% DRIVE-BY ROAD ROUGHNESS ANALYSIS
...
%% USER SETTINGS
fileName = 'Dataset_C_Road_Roughness.xlsx';

sheetNames = {'Zero','Class_A','Class_B','Class_C','Class_D'};
roughnessLabels = {'Zero','Class A','Class B','Class C','Class D'};
vehicleSpeed = 5;                           % m/s
...
saveFigures  = true;
outputFolder = 'DriveBy_Road_Roughness_Results';
...
for i = 1:nCase
    ...
    fprintf('Processing %s | Speed = %.1f m/s\n', ...
        roughnessLabels{i}, vehicleSpeed);
    fprintf('============================================================\n');
    ...
    figDirect = figure('Color','w', ...
        'Name',sprintf('Direct - %s',roughnessLabels{i}), ...
    ...
    title(sprintf(['(a) Bridge acceleration at x = 7 m | %s\n' ...
                   'Peak = %.3g | RMS = %.3g'], ...
        roughnessLabels{i}, Peak_B7(i), RMS_B7(i)));
    ...
    figIndirect = figure('Color','w', ...
        'Name',sprintf('Indirect - %s',roughnessLabels{i}), ...
    ...
    sgtitle(sprintf('Figure %d. Indirect Drive-by Response - %s', ...
        figIndirectNo, roughnessLabels{i}));
...
RoadCondition = string(roughnessLabels(:));
