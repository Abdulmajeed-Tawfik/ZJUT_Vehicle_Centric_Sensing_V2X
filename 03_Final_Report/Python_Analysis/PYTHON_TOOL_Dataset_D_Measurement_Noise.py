# -*- coding: utf-8 -*-
"""
DRIVE-BY MEASUREMENT NOISE ANALYSIS - SPYDER / PYTHON
...
# USER SETTINGS
# =============================================================================
file_name = 'Dataset_D_Measurement_Noise.xlsx'

sheet_names = ['D0_Clean', 'D1_40dB', 'D2_30dB', 'D3_20dB', 'D4_10dB']
noise_labels = ['Clean', '40 dB', '30 dB', '20 dB', '10 dB']
...
save_figures = True
output_folder = 'DriveBy_Measurement_Noise_Results'
...
# MAIN LOOP
# =============================================================================
for i, (sheet, label) in enumerate(zip(sheet_names, noise_labels)):
